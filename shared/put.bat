...
Rem
    ...
    call %scripts%\shared\set.bat shardKey mongo %db% --quiet --eval "var lib_dir='%dependencies%'; var bucket='%bucket%'; var db_shard='%DB_SHARD%'; var file_size=NumberLong('%length%');" %scripts%\shared\shardkey.2a.js
