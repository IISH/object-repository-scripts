...
Rem
    ...
    call %scripts%\shared\set.bat shardKey mongo %db% --quiet --eval "var dependencies='%dependencies%'; var bucket='%bucket%'; var remote_db='%DB_SHARD%'; var file_size=NumberLong('%length%');" %scripts%\shared\shardkey.2a.js
